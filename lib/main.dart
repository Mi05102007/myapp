  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 12, 120, 227)), // Gera um esquema de cores baseado na cor deepPurple.
        useMaterial3: true, // Ativa o estilo Material Design 3.
      ),
      home: const MyHomePage(title: 'Programa Flutter'), // Define a página inicial do aplicativo.
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            const Text(
              ...
              'clique no + para contabilizar os seus pontos:',
            ),
            Text(
